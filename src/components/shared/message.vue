...
.no-conversation-selected .empty-illustration {
  font-size: 4rem;
  margin-bottom: 20px;
  color: #bdc3c7;
}
...
.messages-container {
  ...
  overflow-y: auto;
  scrollbar-width: thin;
  scrollbar-color: #c1c9d1 transparent;
  position: relative;
}
...
/* Update chat header for new elements */
.chat-header {
  display: flex;
  justify-content: space-between;
  align-items: center;
